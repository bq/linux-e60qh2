...
static void ntx_gpio_init(void)
{
	...
	if(31==gptHWCFG->m_val.bPCB||32==gptHWCFG->m_val.bPCB) {
		...
		if(47==gptHWCFG->m_val.bPCB || 52==gptHWCFG->m_val.bPCB || 54==gptHWCFG->m_val.bPCB) {
			// ED0Q0X, E60QGX, ED0Q1X
			// E60Q5X, E60Q32, E60QD2 already defined
		...
		if(37==gptHWCFG->m_val.bPCB) {
			...
			gMX6SL_ON_LED = IMX_GPIO_NR(5, 7);	
				...
				50==gptHWCFG->m_val.bPCB || 55==gptHWCFG->m_val.bPCB) 
		{
			// E60Q9X/E60QAX/E60QFX/E70Q0X .
...
//	imx6q_add_imx_snvs_rtc();
	...
	//	platform_device_register(&ricoh_device_rtc);
		...
		if (40==gptHWCFG->m_val.bPCB || 50==gptHWCFG->m_val.bPCB) {
			// I2C3 set 400kHz for E60Q5x & E60QFx
